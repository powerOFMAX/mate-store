const data: Record<TProductId, TProduct> = {
  ...
  '6trfgkkj': {
    ...
    attributes: {
      ...
      size: 'Small Size (Tennis Ball)',
      weight: '0.25 kg',
      taste: 'Magnificent, is a strong Mate',
    },
  },
  '7bcr49em': {
